...
class CongressConnector(BaseSourceConnector):
    ...
    def metadata(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "{rate_limit_delay:.1f} requests/second",
